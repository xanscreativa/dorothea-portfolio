  ...
  return [
    {
      ...
      avatarImage: "/portfolio/uksw.jpg",
      avatarText: "U",
      avatarBg: "from-pink-500 to-rose-400",
      posts: [
        { type: "full", src: "/portfolio/uksw-1.jpg", alt: "UKSW Mendunia", caption: "UKSW Mendunia" },
        { type: "half", src: "/portfolio/uksw-2.jpg", alt: "Kampus Tour", caption: "Kampus Tour" },
        { type: "half", src: "/portfolio/uksw-3.jpg", alt: "PMB 2026", caption: "PMB 2026" },
        { type: "full", src: "/portfolio/uksw-4.jpg", alt: "Akreditasi Unggul", caption: "Akreditasi Unggul" },
        { type: "half", src: "/portfolio/uksw-5.jpg", alt: "UKSW Menyapa", caption: "UKSW Menyapa" },
        { type: "half", src: "/portfolio/uksw-6.jpg", alt: "Creative Minority", caption: "Creative Minority" },
      ],
      details: {
    ...
    },
    {
      ...
      posts: [
        { type: "full", src: "/portfolio/jendela-1.jpg", alt: "Jendela Finansial 1", caption: "Brand Identity System" },
        { type: "half", src: "/portfolio/jendela-2.jpg", alt: "Jendela Finansial 2", caption: "Digital Application" },
        { type: "half", src: "/portfolio/jendela-3.jpg", alt: "Jendela Finansial 3", caption: "Content Templates" },
        { type: "full", src: "/portfolio/jendela-4.jpg", alt: "Jendela Finansial 4", caption: "Layout Design" },
        { type: "half", src: "/portfolio/jendela-5.jpg", alt: "Jendela Finansial 5", caption: "Visual Asset" },
        { type: "half", src: "/portfolio/jendela-6.jpg", alt: "Jendela Finansial 6", caption: "Mascot Integration" },
      ],
      details: {
  ...
  return [
    {
      ...
      avatarBg: "from-emerald-500 to-teal-400",
      posts: [
        { type: "full", src: "/portfolio/jendela-1.jpg", alt: "Brand Identity Overview", caption: "Brand Identity System & Editorial Grid" }
      ],
      details: {
        client: "Jendela Finansial",
